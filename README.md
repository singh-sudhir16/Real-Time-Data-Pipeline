## Real time Data Pipeline with Apache Airflow, Apache Kafka, Apache Spark, Cassandra and PostgreSQL
...
Before running this project, make sure you have Docker and Docker Compose installed on your machine. Once installed, follow these step-by-step instructions:
  ...
  1. Clone the repository to your local machine: 
       ```
      git clone https://github.com/singh-sudhir16/Real-Time-Data-Pipeline.git
      ```
